...
const (
	...
	ArgoCDDefaultArgoVersion = "v2.11.3" // v2.x.y
	...
	ArgoCDDefaultExportJobVersion = "v0.10.1" // v0.x.y
	...
	ArgoCDDefaultRedisHAProxyVersion = "2.0.35-alpine3.16" // 2.0.35-alpine
